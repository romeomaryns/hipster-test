...
import eu.maryns.app.config.audit.AuditEventConverter;
import eu.maryns.app.domain.PersistentAuditEvent;
...
import static eu.maryns.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
