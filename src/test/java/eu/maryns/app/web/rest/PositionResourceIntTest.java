...
public class PositionResourceIntTest {
    ...
    public void createPosition() throws Exception {
        ...
        assertThat(testPosition.getInstrument()).isEqualTo(DEFAULT_INSTRUMENT);
        assertThat(testPosition.getPl()).isEqualTo(DEFAULT_PL);
        assertThat(testPosition.getUnrealizedPL()).isEqualTo(DEFAULT_UNREALIZED_PL);
        assertThat(testPosition.getResettablePL()).isEqualTo(DEFAULT_RESETTABLE_PL);
        assertThat(testPosition.getCommission()).isEqualTo(DEFAULT_COMMISSION);
    }
    ...
    public void updatePosition() throws Exception {
        ...
        Position testPosition = positionList.get(positionList.size() - 1);
        assertThat(testPosition.getInstrument()).isEqualTo(UPDATED_INSTRUMENT);
        assertThat(testPosition.getPl()).isEqualTo(UPDATED_PL);
        assertThat(testPosition.getUnrealizedPL()).isEqualTo(UPDATED_UNREALIZED_PL);
        assertThat(testPosition.getResettablePL()).isEqualTo(UPDATED_RESETTABLE_PL);
        assertThat(testPosition.getCommission()).isEqualTo(UPDATED_COMMISSION);
    }
